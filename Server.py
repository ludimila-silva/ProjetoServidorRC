...
s = socket.socket(socket.AF_INET, socket.SOCK_STREAM) #acessa o pacote socket impportado do pacote python e o .socket 
...
s.bind(('', 1318)) #cria o acesso ao servidor usando a porta 1318
    ...
    while True: #ficará tentando ate que aja um break do usuario ou sistema
        ...
        if P[0] == b'GET': #caso o primeiro item for 'GET' ele segue a logica
            ...
            if P[1] == b'/':
                ...
                ws.sendall(resp)
                #envia a mensagem para o websocket, ou seja o client(que no nosso caso é o navegador)
